...
export const MOCK_DASHBOARD_SUMMARY: DashboardSummary = {
  ...
  safehouseUtilization: [
    { safehouseName: 'Lighthouse Safehouse 1', currentOccupancy: 8,  capacityGirls: 8  },
    { safehouseName: 'Lighthouse Safehouse 2', currentOccupancy: 8,  capacityGirls: 10 },
    { safehouseName: 'Lighthouse Safehouse 3', currentOccupancy: 9,  capacityGirls: 9  },
    { safehouseName: 'Lighthouse Safehouse 4', currentOccupancy: 12, capacityGirls: 12 },
    { safehouseName: 'Lighthouse Safehouse 5', currentOccupancy: 9,  capacityGirls: 11 },
    { safehouseName: 'Lighthouse Safehouse 6', currentOccupancy: 6,  capacityGirls: 8  },
    { safehouseName: 'Lighthouse Safehouse 7', currentOccupancy: 12, capacityGirls: 12 },
    { safehouseName: 'Lighthouse Safehouse 8', currentOccupancy: 7,  capacityGirls: 9  },
    { safehouseName: 'Lighthouse Safehouse 9', currentOccupancy: 6,  capacityGirls: 6  },
  ],
};

export const MOCK_SAFEHOUSE_PERFORMANCE: SafehousePerformanceSummary = {
  safehouses: [
    { safehouseId: 1, safehouseName: 'Lighthouse Safehouse 1', currentOccupancy: 8,  capacityGirls: 8,  residentCount: 8,  incidentCount: 11, donationAllocationTotal: 25400 },
    { safehouseId: 2, safehouseName: 'Lighthouse Safehouse 2', currentOccupancy: 8,  capacityGirls: 10, residentCount: 8,  incidentCount: 9,  donationAllocationTotal: 22100 },
    { safehouseId: 3, safehouseName: 'Lighthouse Safehouse 3', currentOccupancy: 9,  capacityGirls: 9,  residentCount: 9,  incidentCount: 14, donationAllocationTotal: 28700 },
    { safehouseId: 4, safehouseName: 'Lighthouse Safehouse 4', currentOccupancy: 12, capacityGirls: 12, residentCount: 12, incidentCount: 16, donationAllocationTotal: 31200 },
    { safehouseId: 5, safehouseName: 'Lighthouse Safehouse 5', currentOccupancy: 9,  capacityGirls: 11, residentCount: 9,  incidentCount: 8,  donationAllocationTotal: 19800 },
    { safehouseId: 6, safehouseName: 'Lighthouse Safehouse 6', currentOccupancy: 6,  capacityGirls: 8,  residentCount: 6,  incidentCount: 7,  donationAllocationTotal: 17500 },
    { safehouseId: 7, safehouseName: 'Lighthouse Safehouse 7', currentOccupancy: 12, capacityGirls: 12, residentCount: 12, incidentCount: 15, donationAllocationTotal: 33800 },
    { safehouseId: 8, safehouseName: 'Lighthouse Safehouse 8', currentOccupancy: 7,  capacityGirls: 9,  residentCount: 7,  incidentCount: 10, donationAllocationTotal: 21300 },
    { safehouseId: 9, safehouseName: 'Lighthouse Safehouse 9', currentOccupancy: 6,  capacityGirls: 6,  residentCount: 6,  incidentCount: 10, donationAllocationTotal: 16800 },
  ],
  monthlyTrends: [],
};
