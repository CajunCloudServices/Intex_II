        ...
        "prediction_cards": [
            {
                ...
                "definition": "Count of sessions whose model concern score meets the follow-up threshold in the current data slice.",
            },
            {
                ...
                "definition": "Average predicted concern probability across sessions in view (before applying the binary flag rule).",
            },
            {
                ...
                "definition": "Unique residents with at least one session at or above the follow-up threshold.",
            },
            {
                ...
                "definition": "Of sessions that later had a concern in case notes, what share were already flagged by the model line.",
            },
            {
                ...
                "definition": "Mean change in recorded mood from start to end of session (scale from source data).",
            },
        ],
        "cause_cards": [
            {
                ...
                "definition": "Compares later recorded concerns by starting mood group—association from records, not causal proof.",
            },
            {
                ...
                "definition": "Share of sessions with a recorded concern, split by session format in this export.",
            },
            {
                ...
                "definition": "Baseline rate of concerns documented in case notes across all sessions (ground truth, not the model).",
            },
            {
                ...
                "definition": "Explains how to interpret pattern cards: descriptive comparisons only.",
            },
        ],
